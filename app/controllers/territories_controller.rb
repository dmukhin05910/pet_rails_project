class TerritoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @territory.save
        format.html { redirect_to territory_url(@territory), notice: "Territory was successfully created." }
  ...
  def update
    respond_to do |format|
      if @territory.update(territory_params)
        format.html { redirect_to territory_url(@territory), notice: "Territory was successfully updated." }
